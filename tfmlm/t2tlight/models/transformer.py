...
from t2tlight.utils.attention import *
from t2tlight.utils.layer import *
from t2tlight.models.model import *
...
def transformer_decoder(inputs, memory, bias, mem_bias, params, max_relative_dist=0, state=None, scope=None, layer_outputs=None):
